...
public class Terminal {
     ...
     *
     * @param parser
     *         <strong style="color:'white'">the parser which will set</strong>
     */
     ...
     *
     * @param path
     *         <strong style="color:'white'"> represent the path which will return correctly</strong>
     *
     ...
     *
     * @param args
     *         <strong style="color:'white'"> the arguments which will print</strong>
     *
     ...
     * @param args
     *         <p></p>
     *         -case 1: <strong style="color:'white'">no arguments and changes the current path to the path of your home
     *         directory.</strong>
     *         <p></p>
     *         -case 2: <strong style="color:'white'">1 argument which is “..” (e.g. cd ..) and changes the current
     *         directory to the previous directory.</strong>
     *         <p></p>
     *         -case 3: <strong style="color:'white'">1 argument which is either the full path or the relative (short)
     *         path and changes the current path to that path.</strong> *</blockquote>
     */
     ...
     *
     * @throws IOException
     *         <strong style="color:'white'"> if failed or interrupted I/O operations.</strong>
     *         </blockquote>
     */
     ...
     *         it can be relative or short path represent the directory which will create
     *         </strong>
     *         </blockquote>
     */
    public void mkdir(String... directories) {
        for (String dir : directories) {
            ...
            if (dir.contains("/") || dir.contains("\\")) {
                ...
                dirPath = Paths.get(currentDirectory.toString(), dir);
            }
            try {
     ...
     * @param args
     *         <strong style="color:'white'">
     *         it can be relative or short path represent the directory which will remove
     *         </strong>
     *
     * @throws IOException
     *         <strong style="color:'white'"> if failed or interrupted I/O operations.</strong>
    ...
    public void touch(String... args) throws IOException {
        ...
        if (args[0].contains("/") || args[0].contains("\\")) {
            ...
            dirPath = Paths.get(currentDirectory.toString(), args);
        }
     ...
     *
     * @param args
     *         <strong style="color:'white'"> represent the file names or the directories of them</strong>
     *
     * @throws IOException
     *         <strong style="color:'white'"> if failed or interrupted I/O operations.</strong>
     *         </blockquote>
...
//                Files.write(secondPath, Files.readAllLines(firstPath), StandardOpenOption.APPEND);
     ...
     *
     * @param src
     *         <strong style="color:'white'"> represent the source file</strong>
     * @param dest
     *         <strong style="color:'white'"> represent the destination file</strong>
     *
     * @throws IOException
     *         <strong style="color:'white'"> if failed or interrupted I/O operations.</strong>
     *         </blockquote>
     ...
     *
     * @param args
     *         <strong style="color:'white'"> represent the paths of the files</strong>
     *
     * @throws IOException
     *         <strong style="color:'white'"> if failed or interrupted I/O operations.</strong>
     *         </blockquote>
     ...
     *
     * @param args
     *         <strong style="color:'white'"> represent the file name\s</strong>
     *
     * @return String <strong style="color:'white'"> represent the content of the process</strong>
     * </blockquote>
     *
     * @throws FileNotFoundException
     *         <strong style="color:'white'"> if the file not exit</strong>
     */
    public String cat(String... args) throws IOException {
        Path dirPath1 = pathsHandle(args[0]) ;
        ...
        if (args.length == 2) {
            Path dirPath2 = pathsHandle(args[1]) ;
            if (!Files.exists(dirPath2)){
                System.out.println("file doesn't exist");
                return "";
            }
    ...
    public String wc(String... args) throws IOException {
        if (args.length == 1){
            ...
            return (linecount + " " + wordcount + " " + charcount + " " + dirPath.getFileName().toString());
        }
        else{
     ...
     *
     * @param commandName
     *         <strong style="color:'white'"> represent the command which run</strong>
     * @param args
     *         <strong style="color:'white'"> represent the all arguments</strong>
     * @param ifShouldExist
     *         <strong style="color:'white'"> represent the case of file can create one or not</strong>
     *         </blockquote>
     */
     ...
     *
     * @param content
     *         <strong style="color:'white'"> represent the content which put in the {@code file}</strong>
     * @param file
     *         <strong style="color:'white'"> represent the file which will put into the {@code content}</strong>
     * @param ifShouldExist
     *         <strong style="color:'white'"> represent the case of file</strong>
     *
     * @throws IOException
     *         <strong style="color:'white'"> if failed or interrupted I/O operations.</strong>
     *         </blockquote>
    ...
    public String history() {
        return commandsHistory.toString().replaceAll("\\[", "")
